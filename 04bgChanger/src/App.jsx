    ...
    >
      <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2 ">
        <div className="flex flex-wrap justify-center gap-3 shadow-xl bg-slate-500 px-3 py-2 rounded-3xl">
            ...
            <button onClick={() => setColor("yellow")} className="outline-none px-4 py-1 rounded-full text-black "
            ...
            <button  onClick={() => setColor("lavender")} className="outline-none px-4 py-1 rounded-full text-black"
              style={{backgroundColor: "lavender"}}            
            >Lavender</button>

            <button onClick={() => setColor("white")} className="outline-none px-4 py-1 rounded-full text-black "
